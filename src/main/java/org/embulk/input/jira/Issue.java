...
public class Issue
{
    ...
    public synchronized JsonObject getFlatten(final boolean expandJsonOnGuess)
    {
        if (flatten == null) {
    ...
    private void manipulatingFlattenJson(final JsonElement in, final String prefix, final boolean expandJsonOnGuess)
    {
        if (in.isJsonObject()) {
